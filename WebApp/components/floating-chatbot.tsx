        ...
        <div className={cn("fixed bottom-4 right-4 z-50", className)}>
            ...
            {!isOpen && (
                <Button
                    ...
                    size="icon"
                    className="h-14 w-14 rounded-full bg-primary hover:bg-primary/90 border border-white shadow-lg hover:shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-300 ease-out hover:scale-105 transition-transform"
                >
